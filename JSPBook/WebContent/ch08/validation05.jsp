...
<body id="page-top">
    ...
    function CheckMember() {
    	...
    	//4. 전화번호는 전화번호 형태(숫자)검사
    	var regExpPhone = /^\d{3}-\d{3,4}-\d{4}$/;
    	
    	//5.이메일은 이메일 형식인지
    	//처음 시작이 숫자, 영소대문자이고 특수문자 -_./가 나올수도 있고 안나올수도있고
    	//그 다음에 숫자, 영소대문자가 0개 이상이 온다
    	//@이메일 형식과 같은 내용을 @를 기준으로 이어서
    	//숫자, 영소대문자, -_./이 나올수도 안나올 수도, 숫자, 영소대문자가 0번이상 반복
    	// .이후 영소대문자 2,3자
    	var regExpEmail = /^[0-9a-zA-Z]([-_./]?[0-9a-zA-Z])*@[0-9a-zA-Z]([-_./]?[0-9a-zA-Z]*\.[a-zA-Z]{2,3}$)/i;
    	
    	// i : Ignore Case, 문자열의 대문자와 소문자를 구별하지 않고 검출
    	// g : Global, 문자열 내의 모든 패턴을 검출
    	// m : MultiLine, 문자열 줄 바꿈 행이 있는지 검출
