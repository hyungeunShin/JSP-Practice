                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                	<!--
										1) 아이디, 비밀번호, 이름, 성별, 프로필 이미지를 입력받고 회원가입을 진행
		 
										2) 회원가입 진행 경로는 total_signup_process.jsp로 이동하여 회원가입 처리를 완료
		
										3) 뒤로가기 버튼을 생성하고, 뒤로가기 버튼을 클릭 시 다시 로그인 화면으로 나갈 수 있도록 
									-->
									<form action="total_signup_process.jsp" method="post" enctype="multipart/form-data">
										...
										<a href="http://localhost/JSPBook/ch07/test/total_signin.jsp">뒤로가기</a>
									</form>
                                </div>
                            </div>
                        </div>
