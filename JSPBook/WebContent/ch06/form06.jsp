                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                	<form action="form06_process.jsp" name="member" method="post">
                                		...
                                		취미 : <input type="checkbox" name="hobby1" value="독서" checked="checked"/>독서	 
                                			 <input type="checkbox" name="hobby2" value="운동"/>운동
                                			 <input type="checkbox" name="hobby3" value="영화"/>영화<br/>
                                		<!-- textarea wrap 속성
                                		wrap = "off" : 줄바꿈 안함 
                                		wrap = "soft" : 자동 줄 바꿈
                                		wrap = "hard" : 서버 전송 시 캐리지 리턴(앤터 문자) 문자를 전달
                                		
                                		해당 속성은 html5에서 새롭게 추가된 기능
                                		wrap = "hard" 속성을 사용 시, cols 속성이 꼭 명시 되어 있어야 함 -->
                                		자기소개 : <textarea rows="3" cols="30" placeholder="가입인사를 입력해주세요." wrap="soft" name="comment"></textarea>
